...
type DarkThemeSwitchProps = {
    checked: boolean;
    onChange: (checked: boolean) => void;
};

const DarkThemeSwitch = ({ checked, onChange }: DarkThemeSwitchProps) => {
    return (
        <label className="inline-flex items-center relative cursor-pointer" title="Toggle dark mode">
            <input
