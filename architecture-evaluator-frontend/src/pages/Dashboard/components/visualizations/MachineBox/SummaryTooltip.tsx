...
const CompUnitSummaryTooltip: React.FC<Props> = ({ summary }) => (
    <div className="absolute z-50 left-1/2 -translate-x-1/2 top-full mt-2 w-80 bg-white border border-gray-200 rounded-lg shadow-lg p-4 text-sm text-gray-800">
