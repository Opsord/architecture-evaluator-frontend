        ...
        <div className="min-h-screen flex items-center justify-center bg-background-dark text-white">
            <div className="grid grid-cols-6 grid-rows-5 gap-4 min-h-screen items-center w-full">
                ...
                <div className="col-span-4 col-start-2">
                    <h1 className="text-4xl font-bold text-center text-gray-light dark:text-white">This is a title</h1>
                ...
                <div className="col-span-2 row-span-4 col-start-2 row-start-2 flex items-center justify-center">
                    <span className="text-2xl text-gray-medium">[Espacio para contenido extra]</span>
                </div>
                {/* Section 2 (right) */}
